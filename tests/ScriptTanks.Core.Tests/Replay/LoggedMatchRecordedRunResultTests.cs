...
public sealed class LoggedMatchRecordedRunResultTests
{
    ...
    public void Constructor_PreservesValues()
    {
        ...
        LoggedMatchRecordedRunResult result = new LoggedMatchRecordedRunResult(
            recordedRunResult,
            log);
    ...
    public void Constructor_RejectsNullRecordedRunResult()
    {
        ...
        ArgumentNullException ex = Assert.Throws<ArgumentNullException>(
            () => new LoggedMatchRecordedRunResult(null!, log));
    ...
    public void Constructor_RejectsNullLog()
    {
        ...
        ArgumentNullException ex = Assert.Throws<ArgumentNullException>(
            () => new LoggedMatchRecordedRunResult(recordedRunResult, null!));
    ...
    public void Equals_UsesReferenceEquality()
    {
        MatchRecordedRunResult recordedRunResult = CreateRecordedRunResult();
        CombatLog log = CreateLog();
        LoggedMatchRecordedRunResult a = new LoggedMatchRecordedRunResult(
            recordedRunResult,
            log);
        LoggedMatchRecordedRunResult b = new LoggedMatchRecordedRunResult(
            recordedRunResult,
            log);
